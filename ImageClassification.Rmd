...
- The `caret` ("Classification And REgression Training") package documentation: [https://topepo.github.io/caret]
- various sources from Google searches on training parameters such as [https://machinelearningmastery.com/tune-machine-learning-algorithms-in-r/] 
...
```{r falseColor, message=FALSE, warning=FALSE}
